...
function RegistrationRichTextView({
  ...
  const tableLayoutClassName = isArticle
    ? "[&_table]:table [&_table]:max-w-full [&_table]:table-auto [&_table]:border-separate [&_table]:border-spacing-0 [&_table]:overflow-hidden"
    : "[&_table]:block [&_table]:max-w-full [&_table]:overflow-x-auto [&_table]:border-collapse";
  const articleClassName = isArticle
    ? "[&>p:first-of-type]:text-[0.975rem] [&>p:first-of-type]:leading-[1.75] [&>p:first-of-type]:text-navy-800/78 [&_h2]:text-balance [&_h2]:border-b [&_h2]:border-cobalt-700/12 [&_h2]:pb-2 [&_h3]:text-balance [&_h3]:border-b [&_h3]:border-cobalt-700/10 [&_h3]:pb-2 [&_hr]:my-6 [&_p]:max-w-none [&_p]:text-pretty [&_strong]:font-semibold [&_table]:mb-10 [&_table]:w-full [&_table]:rounded-[16px] [&_table]:border [&_table]:border-cobalt-700/16 [&_table]:bg-cloud [&_table]:text-[0.9375rem] [&_table]:leading-6 [&_table]:shadow-[inset_0_4px_0_var(--blue-electric),0_10px_30px_rgba(3,19,47,0.06)] [&_table_th]:[border-width:0_1px_1px_0] [&_table_th]:bg-ice/90 [&_table_th]:px-4 [&_table_th]:pb-3.5 [&_table_th]:pt-4 [&_table_th]:font-semibold [&_table_th:first-child]:w-1/4 [&_table_th:first-child]:font-medium [&_table_td]:[border-width:0_1px_1px_0] [&_table_td]:bg-white/55 [&_table_td]:px-4 [&_table_td]:py-3.5 [&_table_td]:align-middle [&_table_td:first-child]:font-medium [&_table_td:first-child]:text-navy-800 [&_table_tr>*:last-child]:border-r-0 [&_table_tbody_tr:last-child_td]:border-b-0 [&_tbody_tr:nth-child(even)_td]:bg-ice/25 [&_tbody_tr]:transition-colors [&_tbody_tr]:duration-150 [&_tbody_tr:hover_td]:!bg-ice/65 [&_tbody_tr:hover_td:first-child]:shadow-[inset_4px_0_0_var(--blue-electric)]"
    : "";
  const richTextClassName = `${className} min-w-0 ${spacingClassName} ${listClassName} ${headingClassName} ${tableLayoutClassName} ${articleClassName} [&_a]:rounded-sm [&_a]:font-bold [&_a]:underline [&_a]:decoration-sky/55 [&_a]:underline-offset-4 [&_a]:transition-colors [&_a]:focus-visible:outline-none [&_a]:focus-visible:ring-2 [&_a]:focus-visible:ring-sky [&_a]:focus-visible:ring-offset-2 [&_blockquote]:rounded-r-xl [&_blockquote]:border-l-2 [&_blockquote]:px-4 [&_blockquote]:py-2 [&_blockquote]:italic [&_code]:break-words [&_code]:rounded [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-[0.88em] [&_h4]:text-[1.05rem] [&_h4]:font-extrabold [&_h5]:text-[1rem] [&_h5]:font-extrabold [&_h6]:text-[0.92rem] [&_h6]:font-extrabold [&_hr]:border-0 [&_hr]:border-t [&_img]:h-auto [&_img]:max-w-full [&_img]:rounded-xl [&_img]:border [&_img]:object-contain [&_mark]:rounded [&_mark]:bg-sky/35 [&_mark]:px-1 [&_p]:whitespace-pre-line [&_pre]:max-w-full [&_pre]:overflow-x-auto [&_pre]:rounded-xl [&_pre]:border [&_pre]:p-4 [&_pre]:text-sm [&_pre_code]:bg-transparent [&_pre_code]:p-0 [&_strong]:font-extrabold [&_td]:border [&_td]:p-2.5 [&_th]:border [&_th]:p-2.5 [&_th]:text-left [&_th]:font-extrabold ${
    light
