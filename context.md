...
| `cms/CONTENT_MODEL.md` | Definitive editorial contract: five single types, thirty-seven collections, and sixty-four components. Change it deliberately alongside the schemas and Next mapper. |
...
- An optional editor-managed Written By card follows Extra Content and precedes
...
- The Strapi v5 CMS is implemented in `cms/`: five single types (`site-setting`,
  ...
  collections, sixty-four components, and core REST route/controller/service
