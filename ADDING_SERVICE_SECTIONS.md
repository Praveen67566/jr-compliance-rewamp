...
- Optional decorative icons stay inside their intended circular holders, use
  empty alternative text, and render only in Challenges, Advantages, Process,
  Why Choose, and Breakdown.
